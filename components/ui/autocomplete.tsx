...
export default function Autocomplete({ value, onChange, suggestions, placeholder, className }: AutocompleteProps) {
  ...
  return (
    <div ref={containerRef} className={cn('relative', className)}>
      <input
        ...
        className="h-8 w-full px-2 rounded-md border border-slate-300 text-sm focus:ring-2 focus:ring-blue-400"
      />
