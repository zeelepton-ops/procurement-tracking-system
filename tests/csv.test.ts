...
describe('CSV util', () => {
  it('generates CSV for job orders with totals', () => {
    const jobs = [
      { jobNumber: '001', productName: 'Widget', clientName: 'ACME', foreman: 'Guna', priority: 'HIGH', createdAt: new Date('2025-01-01T00:00:00Z'), items: [{ workDescription: 'Make', quantity: 2, unit: 'PCS', totalPrice: 123.45 }], discount: 10, roundOff: 0.55 }
    ]
